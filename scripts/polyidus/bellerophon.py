...
import os
import psutil
from utils import bellerophonEngine
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outdir",
        default=os.path.join(os.getcwd(), "bellerophonOutput"),
